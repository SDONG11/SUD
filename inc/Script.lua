...
'📬┊الا يمكنني عرض صورتك لانك قمت بحظر البوت او ليس لديك صوره ...!\n'..'['..UserNameID..']'
..'🎁┊ايديـك ❪ '..msg.sender_user_id_..' ❫\n'
..'📡┊رتبتـك ❪ '..msg.TheRank..' ❫\n'
..'🎲┊تفاعلك ❪ '..Get_Ttl(msgs)..' ❫\n'
..'💬┊رسائلك ❪ '..msgs..' ❫\n'
...
if (MsgText[1] == "رفع منشي" or MsgText[1] == "رفع منشئ") then
...
if (MsgText[1] == "تنزيل منشي" or MsgText[1] == "تنزيل منشئ" ) then
if not msg.SudoUser then return "🎍*┊*هذا الامر يخص {المطور,المطور الاساسي} فقط  \n❕" end
if not MsgText[2] and msg.reply_id then
...
if MsgText[1] == "حظر" or MsgText[1] == ""..Bot_Name.."احظر"  then
if not msg.Admin then return "🎍*┊*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
if not MsgText[2] and msg.reply_id then 
...
local user_info_ = redis:get(boss..'user:Name' .. result.sender_user_id_)
local boss_res = user_info_
if user_info_ then
HTTPS.request("https://api.telegram.org/bot" .. ApiToken .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=false")
sendMsg(msg.chat_id_, msg.id_, 1, '👤╿❯ *العضو* « ['..boss_res..'] »\n💯┊❯ *ايديه* « *'..result.sender_user_id_..'* »\n📌┊❯ *بواسطه « '..renk_boss(msg)..' »*\n☑️╽❯ *تم رفعه « ادمن بالكروب » *', 1, 'md')
end
end
...
local boss_res = user_info_
if user_info_ then
HTTPS.request("https://api.telegram.org/bot" .. ApiToken .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
sendMsg(msg.chat_id_, msg.id_, 1, '👤╿❯ *ادمن الكروب* « ['..boss_res..'] »\n💯┊❯ *ايديه* « *'..result.sender_user_id_..'* »\n📌┊❯ *بواسطه « '..renk_boss(msg)..' »*\n☑️╽❯ *تم تنزيله « عضو » *', 1, 'md')
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end 
...
local boss_res = user_info_
if user_info_ then
HTTPS.request("https://api.telegram.org/bot" .. ApiToken .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
...
return '👨🏾‍🔧┊ اصدار سورس سيود : احـدث اصـدار \n📡'
end
...
local inline = {{{text="⚜┊قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/https://t.me/joinchat/AAAAAFf4w0GKa02Blb0BUA"}}}
send_key(msg.sender_user_id_,'  [⚜┊قناة سورس : سيود](t.me/https://t.me/joinchat/AAAAAFf4w0GKa02Blb0BUA)',nil,inline,msg.id_)
return false
end
...
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
📝┊اذاعه ↭ لنشر اذاعه للكل
📭┊اذاعه خاص ↭ لنشر رساله للجميع في الخاص
...
return [[
📮┊اهلا بك في سورس سـيود🎅

💍┊السورس قيد التطوير عند اكتماال السورس سيتم نشره تابع قناه السورس
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
📡┊[قناة السورس](https://t.me/joinchat/AAAAAFf4w0GKa02Blb0BUA) [@Y_YGY]
...
return '🚸*¦*  عدد سـحكاتي ⇜ ❪ '..(redis:get(boss..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end
...
⭐*¦* اختصاصي حماية كروبات 
🔖*¦* لتفعيل البوت اتبع مايلي↭ •
📂*¦* اضف البوت الى المجموعهہ‏‏ ↭ ¹
📕*¦* ارفع البوت ادمن في المجموعهہ‏‏ ↭ ²
🎻*¦* وارسل كلمـهہ‏‏ `تفعيل` ↭ ³
