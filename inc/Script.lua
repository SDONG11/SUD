...
local function iALI(msg,MsgText)
...
if redis:get(ALI..'lock_id'..msg.chat_id_) then
local msgs = redis:get(ALI..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "🎫┇معرفـك ❪ @"..data.username_.." ❫\n" else UserNameID = "" end
local points = redis:get(ALI..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(ALI..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(ALI..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
local GroupName = (redis:get(ALI..'group:name'..msg.chat_id_) or '')
redis:set(ALI..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
if not msg.Director and redis:get(ALI..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(ALI..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
if not redis:get(ALI..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(ALI..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(ALI..'ExCmdLink'..msg.chat_id_,120,true)
...
if not redis:get(ALI..'linkGroup'..msg.chat_id_) then 
return "📡*¦* اوه 🙀 لا يوجد رابط ☹️\n🔖*¦*لانشاء رابط ارسل { انشاء رابط } \n📡" 
end
local GroupName = redis:get(ALI..'group:name'..msg.chat_id_)
local GroupLink = redis:get(ALI..'linkGroup'..msg.chat_id_)
...
local Text = "🔖¦رابـط الـمـجـمـوعه 💯\n🌿¦ "..Flter_Markdown(redis:get(ALI..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(ALI..'flood'..msg.chat_id_,MsgText[2]) 
...
local Admins = redis:scard(ALI..'admins:'..msg.chat_id_)
if Admins ==0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ادمنيه ليتم مسحهم ✓" 
end
redis:del(ALI..'admins:'..msg.chat_id_)
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
local Mn3Word = redis:scard(ALI..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "📡*¦* عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(ALI..':Filter_Word:'..msg.chat_id_)
...
redis:del(ALI..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
if not redis:get(ALI..'welcome:msg'..msg.chat_id_) then 
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(ALI..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(ALI..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "📛¦ عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(ALI..':MONSHA_BOT:'..msg.chat_id_)
...
local NumMDER = redis:scard(ALI..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "📛¦ عذرا لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(ALI..'owners:'..msg.chat_id_)
...
local list = redis:smembers(ALI..'banned:'..msg.chat_id_)
if #list == 0 then return "*📌¦ لا يوجد مستخدمين محظورين  *" end
message = '📋*¦* قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(ALI..'banned:'..msg.chat_id_)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
local MKTOMEN = redis:scard(ALI..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "📡*¦* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(ALI..'is_silent_users:'..msg.chat_id_)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..MKTOMEN.." *} من المكتومين  \n✓"
end

if MsgText[2] == 'المميزين' then
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
local MMEZEN = redis:scard(ALI..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*⚙️*¦ لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(ALI..'whitelist:'..msg.chat_id_)
...
redis:del(ALI..'linkGroup'..msg.chat_id_)
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
redis:setex(ALI..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(ALI..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
redis:setex(ALI..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(ALI..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(ALI..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(ALI..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(ALI..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
redis:setex(ALI..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(ALI..'CheckExpire::'..msg.chat_id_) then 
redis:set(ALI..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️¦ في مجموعه  » »  '..redis:get(ALI..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور} فقط  \n❕" end
if MsgText[2] == '1' then
redis:setex(ALI..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(ALI..'CheckExpire::'..msg.chat_id_) then 
redis:set(ALI..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم تفعيل الاشتراك   👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم تفعيل الاشتراك  👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(ALI..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(ALI..'CheckExpire::'..msg.chat_id_) then 
redis:set(ALI..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(ALI..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(ALI..'CheckExpire::'..msg.chat_id_) then 
redis:set(ALI..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
local check_time = redis:ttl(ALI..'ExpireDate:'..msg.chat_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(ALI..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(ALI..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(ALI..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(ALI..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(ALI..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(ALI..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(ALI..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(ALI..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(ALI..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
return '🧟‍♂*¦*  عدد جهہآتگ آلمـضـآفهہ‏‏ ⇜ ❪ '..(redis:get(ALI..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
redis:set(ALI..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
if redis:get(ALI..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(ALI..'welcome:msg'..msg.chat_id_))
else 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."  \n🌿¦ نورت المجموعه \n💂🏼‍♀️" 
end 
end
...
local groups = redis:smembers(ALI..'group:ids')
...
local pv = redis:smembers(ALI..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(ALI..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(ALI..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜┊اهلا انآ بوت آسـمـي ]]..redis:get(ALI..':NameBot:')..[[ ✓
...
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور} فقط  \n❕" end
if redis:sismember(ALI..'group:ids',MsgText[2]) then
local name_gp = redis:get(ALI..'group:name'..MsgText[2])
...
return redis:get(ALI..":TEXT_SUDO") or '🗃¦ لا توجد كليشه المطور .\n📰¦ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"♦️*┇*هذا الامر يخص {المطور} فقط  \n❕" end
if not msg.SudoBase and not redis:get(ALI..'lock_brod') then 
return "📡*¦* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
redis:setex(ALI..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(ALI..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(ALI..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(ALI..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
redis:del(ALI..'welcom:witting'..msg.sender_user_id_,
ALI..'rulse:witting'..msg.sender_user_id_,
ALI..'rulse:witting'..msg.sender_user_id_,
ALI..'name:witting'..msg.sender_user_id_,
ALI..'about:witting'..msg.sender_user_id_,
ALI..'fwd:all'..msg.sender_user_id_,
ALI..'fwd:pv'..msg.sender_user_id_,
ALI..'fwd:groups'..msg.sender_user_id_,
ALI..'namebot:witting'..msg.sender_user_id_,
ALI..'addrd_all:'..msg.sender_user_id_,
ALI..'delrd:'..msg.sender_user_id_,
ALI..'addrd:'..msg.sender_user_id_,
ALI..'delrdall:'..msg.sender_user_id_,
ALI..'text_sudo:witting'..msg.sender_user_id_,
ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_,
ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n❕" end
local GetVerison = https.request('https://github.com/SDONG11/SUD.github.io/GetVersion.txt') or 0
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'🔛*┊* يوجد تحديث جديد الان \n📡*┊* جاري تنزيل وتثبيت التحديث  ...')
redis:set(ALI..":VERSION",GetVerison)
return false
else
return "🔖┊سـورس سيود\n👨🏾‍🔧*┊* لديـك احدث اصدار \n📦"
end
...
local inline = {{{text="⚜┇قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/y_ygy"}}}
send_key(msg.sender_user_id_,'  [⚜┇قناة السورس : ](t.me/https://t.me/joinchat/AAAAAFf4w0GKa02Blb0BUA)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 🔍" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n❕" end
return '🎭┊الاحصائيات 🏌‍♂ \n\n👥*┊*عدد المجموعات المفعله : '..redis:scard(ALI..'group:ids')..'\n👤*┊*عدد المشتركين في البوت : '..redis:scard(ALI..'users')..'\n📡'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n❕" end
redis:setex(ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(ALI..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "📭¦ حسننا الان ارسل كلمة الرد العام 🍃\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
local names 	= redis:exists(ALI..'replay:'..msg.chat_id_)
local photo 	= redis:exists(ALI..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(ALI..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(ALI..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(ALI..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(ALI..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(ALI..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(ALI..'replay:'..msg.chat_id_,ALI..'replay_photo:group:'..msg.chat_id_,ALI..'replay_voice:group:'..msg.chat_id_,
ALI..'replay_animation:group:'..msg.chat_id_,ALI..'replay_audio:group:'..msg.chat_id_,ALI..'replay_sticker:group:'..msg.chat_id_,ALI..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(ALI..'replay:all')
local photo 	= redis:exists(ALI..'replay_photo:group:')
local voice 	= redis:exists(ALI..'replay_voice:group:')
local imation 	= redis:exists(ALI..'replay_animation:group:')
local audio 	= redis:exists(ALI..'replay_audio:group:')
local sticker 	= redis:exists(ALI..'replay_sticker:group:')
local video 	= redis:exists(ALI..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(ALI..'replay:all',ALI..'replay_photo:group:',ALI..'replay_voice:group:',ALI..'replay_animation:group:',ALI..'replay_audio:group:',ALI..'replay_sticker:group:',ALI..'replay_video:group:')
...
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n❕" end
redis:set(ALI..'delrdall:'..msg.sender_user_id_,true) 
return "📭┊حسننا عزيزي  ✋🏿\n🗯┊الان ارسل الرد لمسحها من  المجموعات 🍃"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
redis:set(ALI..'delrd:'..msg.sender_user_id_,true)
return "📭┊حسننا عزيزي  ✋🏿\n🗯┊الان ارسل الرد لمسحها من  للمجموعه 🍃"
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
local names  	= redis:hkeys(ALI..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(ALI..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(ALI..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(ALI..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(ALI..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(ALI..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(ALI..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(ALI..'replay:all')
local photo 	= redis:hkeys(ALI..'replay_photo:group:')
local voice 	= redis:hkeys(ALI..'replay_voice:group:')
local imation 	= redis:hkeys(ALI..'replay_animation:group:')
local audio 	= redis:hkeys(ALI..'replay_audio:group:')
local sticker 	= redis:hkeys(ALI..'replay_sticker:group:')
local video 	= redis:hkeys(ALI..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '🚸*┊*لا يوجد ردود مضافه حاليا \n❕' 
end
local ii = 1
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
redis:setex(ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(ALI..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "📭┊حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n❕" end
redis:setex(ALI..'namebot:witting'..msg.sender_user_id_,300,true)
...
🎮┇نقآطـي ⇜ لمعرفه عدد نقآطـك
🎮┇بيع نقآطـي + العدد ⇜ لبيع مجموهراتك لتحصل على رسائل 
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
if not redis:get(ALI..'lave_me'..msg.chat_id_) then 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(ALI..'lave_me'..msg.chat_id_) 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
if redis:get(ALI..'lave_me'..msg.chat_id_) then 
return "🙋??‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(ALI..'lave_me'..msg.chat_id_,true)  
...
return [[
📮┇اهلا بك في سورس  سيود🍃
💎┇السورس ليس متكامل عند اكتمال سورس سوف يتم نشره تابع قناه السورس
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
📡┇[قناة السورس](t.me/https://t.me/joinchat/AAAAAFf4w0GKa02Blb0BUA) [@Y_YGY]
...
return '🚸*¦*  عدد سحہكآتگ ⇜ ❪ '..(redis:get(ALI..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end

if MsgText[1] == "تفعيل الاشتراك الاجباري" or MsgText[1] == "تفعيل الاشتراك الاجباري 💯" then
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n❕" end
if redis:get(ALI..":UserNameChaneel") then
return "📑┊اهلا عزيزي المطور \n🔖┊الاشتراك بالتأكيد مفعل"
else
redis:setex(ALI..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n❕" end
local SubDel = redis:del(ALI..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n❕" end
local UserChaneel = redis:get(ALI..":UserNameChaneel")
if UserChaneel then
...
local function dALI(msg)

if msg.type == "pv" then 

if not msg.SudoUser then
local msg_pv = tonumber(redis:get(ALI..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(ALI..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛¦* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(ALI..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(ALI..'users',msg.sender_user_id_)
if redis:get(ALI..'lock_service') then 
text = [[📥┇اهلا انآ بوت آسـمـي   []]..redis:get(ALI..':NameBot:')..[[] 🎖
👨🏻‍✈️┊آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛┇مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
🔖┇لتفعيل البوت اتبع مايلي
🎑┇اضف البوت الى المجموعتك
📮┇ وثم ارفع لبوت مشرف في قناتك
💌┇ ثم ارسل كلمه `تفعيل`
...
local MSG_ID = (redis:get(ALI.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(ALI..'lock_twasel') then
...
redis:setex(ALI.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group =====================================
if redis:get(ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(ALI..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(ALI..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(ALI..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد 🚀 \n-')
elseif msg.photo then 
redis:hset(ALI..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه صوره للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.voice then
redis:hset(ALI..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه بصمه صوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.animation then
redis:hset(ALI..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه متحركه للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.video then
redis:hset(ALI..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه فيديو للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.audio then
redis:hset(ALI..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه للصوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.sticker then
redis:hset(ALI..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(ALI..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(ALI..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(ALI..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد لكل المجموعات 🚀 ')
elseif msg.photo then 
redis:hset(ALI..'replay_photo:group:',klma,photo_id)
redis:del(ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه صوره للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.voice then
redis:hset(ALI..'replay_voice:group:',klma,voice_id)
redis:del(ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه بصمه صوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.animation then
redis:hset(ALI..'replay_animation:group:',klma,animation_id)
redis:del(ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه متحركه للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.video then
redis:hset(ALI..'replay_video:group:',klma,video_id)
redis:del(ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه فيديو للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.audio then
redis:hset(ALI..'replay_audio:group:',klma,audio_id)
redis:del(ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه للصوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.sticker then
redis:hset(ALI..'replay_sticker:group:',klma,sticker_id)
redis:del(ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(ALI..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(ALI..":ForceSub:"..msg.sender_user_id_)
...
redis:set(ALI..":UserNameChaneel",msg.text)
...
if redis:get(ALI..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(ALI..'namebot:witting'..msg.sender_user_id_)
redis:set(ALI..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"📭┊تم تغير اسم البوت  ✋🏿\n🗯┊الان اسمه "..Flter_Markdown(msg.text).." \n✓")
return false
end

if redis:get(ALI..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(ALI..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(ALI..'replay_photo:group:',msg.text)
redis:hdel(ALI..'replay_voice:group:',msg.text)
redis:hdel(ALI..'replay_animation:group:',msg.text)
redis:hdel(ALI..'replay_audio:group:',msg.text)
redis:hdel(ALI..'replay_sticker:group:',msg.text)
redis:hdel(ALI..'replay_video:group:',msg.text)
redis:setex(ALI..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜┊جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛┊[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] ✓\n-")
end
end

if redis:get(ALI..'delrdall:'..msg.sender_user_id_) then
redis:del(ALI..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(ALI..'replay:all',msg.text)
local photo =redis:hget(ALI..'replay_photo:group:',msg.text)
local voice = redis:hget(ALI..'replay_voice:group:',msg.text)
local animation = redis:hget(ALI..'replay_animation:group:',msg.text)
local audio = redis:hget(ALI..'replay_audio:group:',msg.text)
local sticker = redis:hget(ALI..'replay_sticker:group:',msg.text)
local video = redis:hget(ALI..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*┊*هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(ALI..'replay:all',msg.text)
redis:hdel(ALI..'replay_photo:group:',msg.text)
redis:hdel(ALI..'replay_voice:group:',msg.text)
redis:hdel(ALI..'replay_audio:group:',msg.text)
redis:hdel(ALI..'replay_animation:group:',msg.text)
...
if redis:get(ALI..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(ALI..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(ALI..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "📜*¦* تم وضع الكليشه بنجاح كلاتي 👋🏻\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(ALI..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(ALI..'welcom:witting'..msg.sender_user_id_) 
redis:set(ALI..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*¦* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(ALI..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(ALI..'rulse:witting'..msg.sender_user_id_) 
redis:set(ALI..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'📜*¦* مرحبآ عزيزي\n📦¦ تم حفظ القوانين بنجاح ✓\n🔖¦ ارسل [[ القوانين ]] لعرضها \n💬✓')
end
if redis:get(ALI..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(ALI..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(ALI..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(ALI..'about:witting'..msg.sender_user_id_) 
...
if redis:get(ALI..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(ALI..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(ALI..'users')  
local groups = redis:smembers(ALI..'group:ids')
...
if redis:get(ALI..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(ALI..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(ALI..'users')
if #pv >= 300 then
...
if redis:get(ALI..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(ALI..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(ALI..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(ALI..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(ALI..':WELCOME_BOT'),[[⚜┊اهلا انآ بوت آسـمـي ]]..redis:get(ALI..':NameBot:')..[[ ✓
👨🏻‍✈️┊آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛┊مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
if msg.forward_info and redis:get(ALI..'fwd:'..msg.sender_user_id_) then
redis:del(ALI..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(ALI..'users')
local groups = redis:smembers(ALI..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.photo and redis:get(ALI..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(ALI..'welcom_ph:witting'..msg.sender_user_id_)
redis:set(ALI..':WELCOME_BOT',photo_id)
sendMsg(msg.chat_id_,msg.id_,'🚸 ¦ تم تغيير صـورهہ‏‏ آلترحيب للبوت 🌿\n✓')
return false
end 

if msg.photo and msg.type == "channel" and msg.GroupActive then
if redis:get(ALI..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(ALI..'photo:group'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(ALI..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(ALI..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(ALI..'replay:'..msg.chat_id_,msg.text)
redis:hdel(ALI..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(ALI..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(ALI..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(ALI..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(ALI..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(ALI..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(ALI..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜┊جيد , يمكنك الان ارسال جواب الرد \n🔛┊[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] ✓\n-")
end
end

if redis:get(ALI..'delrd:'..msg.sender_user_id_) then
redis:del(ALI..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(ALI..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(ALI..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(ALI..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(ALI..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(ALI..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(ALI..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(ALI..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*┊*هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(ALI..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(ALI..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(ALI..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(ALI..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(ALI..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(ALI..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(ALI..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(ALI..'welcome:msg'..msg.chat_id_) or "🙋🏻‍♂¦ اهلن بك عزيزي {الاسم}\n🎟¦ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ♥\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚜¦ اسم الكروب » {المجموعه}")
if welcome then
rules = (redis:get(ALI..'rulse:msg'..msg.chat_id_) or "👨🏻‍💻¦ مرحبأ عزيري القوانين كلاتي 👇🏻\n📛¦ ممنوع نشر الروابط\n⚠️¦ ممنوع التكلم او نشر صور اباحيه\n⚔¦ ممنوع  اعاده توجيه\n💭¦ ممنوع التكلم بلطائفه\n♥️¦ الرجاء احترام المدراء والادمنيه 😅\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(ALI..'group:name'..msg.chat_id_) or '')))
...
--------------------------------------------
if msg.adduser and redis:get(ALI..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(ALI..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(ALI..'welcome:get'..msg.chat_id_)
end
redis:setex(ALI..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(ALI..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(ALI..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_SUD = (redis:get(ALI..'num_msg_SUD'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_SUD) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(ALI..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"👤¦ العضو » "..USERNAME.."\n🚸¦ قمـت بتگرآر آگثر مـن "..NUM_MSG_SUD.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
redis:setex(ALI..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
 
 
if msg.forward_info_ then
if redis:get(ALI..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(ALI..'lock_woring'..msg.chat_id_) and not redis:get(ALI..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(ALI..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(ALI..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(ALI..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*¦* لا يمكنني مسح الرساله المخالفه .\n🎟*¦* لست مشرف او ليس لدي صلاحيه  الحذف \n ❕')    
end
if redis:get(ALI..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(ALI..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(ALI..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(ALI..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(ALI..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(ALI..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(ALI..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(ALI..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(ALI..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(ALI..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(ALI..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(ALI..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(ALI..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(ALI..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(ALI..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(ALI..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(ALI..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(ALI..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(ALI..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(ALI..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(ALI..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(ALI..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(ALI..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(ALI..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(ALI..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(ALI..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(ALI..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(ALI..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(ALI..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(ALI..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(ALI..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ALI..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(ALI..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ALI..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ALI..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ALI..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(ALI..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ALI..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(ALI..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ALI..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ALI..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ALI..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
if redis:get(ALI..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(ALI..'ExpireDate:'..msg.chat_id_)
if not ExpireDate and not msg.SudoUser then
rem_data_group(msg.chat_id_)
sendMsg(SUDO_ID,0,'🕵🏼️‍♀️¦ انتهى الاشتراك في احد المجموعات ✋🏿\n👨🏾‍🔧¦ المجموعه : '..FlterName(redis:get(ALI..'group:name'..msg.chat_id_))..'🍃\n💂🏻‍♀️¦ ايدي : '..msg.chat_id_)
sendMsg(msg.chat_id_,0,'🕵🏼️‍♀️¦ انتهى الاشتراك البوت✋🏿\n💂🏻‍♀️¦ سوف اغادر المجموعه فرصه سعيده 👋🏿\n👨🏾‍🔧¦ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
return StatusLeft(msg.chat_id_,our_id)
else
local DaysEx = (redis:ttl(ALI..'ExpireDate:'..msg.chat_id_) / 86400)
