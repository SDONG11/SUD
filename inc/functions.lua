...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ALI..":NameBot:")
...
var = 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(ALI..':SUDO_BOT:',UserID) then
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(ALI..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(ALI..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(ALI..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(ALI..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(ALI..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(ALI..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(ALI..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(ALI..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(ALI..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(ALI..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(ALI..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(ALI..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(ALI..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(ALI..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`👨‍✈️┇مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info = redis:hgetall(ALI..'username:'..v)
local count = redis:scard(ALI..'mtwr_count'..v)
...
local monsha = redis:smembers(ALI..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n\n📋¦ قائمه المدراء :*\n\n'
local list = redis:smembers(ALI..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(ALI..'admins:'..msg.chat_id_)
...
local list = redis:smembers(ALI..'whitelist:'..msg.chat_id_)
...
if redis:sismember(ALI..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(ALI..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(ALI..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(ALI..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(ALI..'gban_users')
...
local list = redis:smembers(ALI..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(ALI..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*┇*الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(ALI..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(ALI..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(ALI..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(ALI..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(ALI..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(ALI..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(ALI..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..ALI..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(ALI..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(ALI..'group:name'..GroupS) or '')
...
local admins = redis:smembers(ALI..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(ALI..'username:'..value)
if info then 
...
local creator = redis:smembers(ALI..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(ALI..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(ALI..'group:ids')
message = '📋*┇*قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(ALI..'group:name'..v)
if info then 
...
redis:del(
ALI..'group:add'..id_group,
ALI..'lock_link'..id_group, 
ALI..'lock_id'..id_group,
ALI..'lock_spam'..id_group, 
ALI..'lock_webpage'..id_group,
ALI..'lock_markdown'..id_group,
ALI..'lock_flood'..id_group,
ALI..'lock_bots'..id_group,
ALI..'mute_forward'..id_group,
ALI..'mute_contact'..id_group,
ALI..'mute_location'..id_group,
ALI..'mute_document'..id_group,
ALI..'mute_keyboard'..id_group,
ALI..'mute_game'..id_group,
ALI..'mute_inline'..id_group,
ALI..'lock_username'..id_group,
ALI..'num_msg_SUD'..id_group,
ALI..'replay'..id_group
)
redis:srem(ALI..'group:ids',id_group)
end
...
redis:hset(ALI..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(ALI..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(ALI..'group:add'..msg.chat_id_) then  return '🎗*┊*المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
redis:setex(ALI..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(ALI..':addnumberusers') or 0)
...
local lock_service = redis:get(ALI..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(ALI..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(ALI..':MONSHA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
ALI..'group:add'..msg.chat_id_,true,
ALI..'lock_link'..msg.chat_id_,true, 
ALI..'lock_id'..msg.chat_id_,true,
ALI..'lock_spam'..msg.chat_id_,true,
ALI..'lock_webpage'..msg.chat_id_,true,
ALI..'lock_markdown'..msg.chat_id_,true,
ALI..'lock_flood'..msg.chat_id_,true,
...
ALI..'mute_keyboard'..msg.chat_id_,true,
ALI..'mute_game'..msg.chat_id_,true,
ALI..'mute_inline'..msg.chat_id_,true,
ALI..'lock_username'..msg.chat_id_,true,
ALI..'num_msg_SUD'..msg.chat_id_,5, 
ALI..'replay'..msg.chat_id_,true
)

redis:sadd(ALI..'group:ids',msg.chat_id_) 
redis:sadd(ALI..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(ALI..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(ALI..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(ALI..'group:add'..msg.chat_id_) then return '🛠*┊* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
if redis:sismember(ALI..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(ALI..'username:'..UserID,'username',Resolv)
redis:sadd(ALI..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح منشىء في البوت \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(ALI..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(ALI..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(ALI..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(ALI..'username:'..UserID, 'username', Resolv)
redis:sadd(ALI..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(ALI..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(ALI..'whitelist:'..ChatID,UserID)
...
if redis:sismember(ALI..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(ALI..'username:'..UserID, 'username', Resolv)
redis:sadd(ALI..'owners:'..ChatID,UserID)
...
if redis:sismember(ALI..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(ALI..'username:'..UserID, 'username', Resolv)
redis:sadd(ALI..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(ALI..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(ALI..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(ALI..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(ALI..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(ALI..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(ALI..'username:'..UserID, 'username', Resolv)
redis:sadd(ALI..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم حظره  \n✓️',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(ALI..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتأكيد الغاء حظره  \n✓️',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء حظره \n✓️',17,USERCAR) 
end
redis:srem(ALI..'banned:'..ChatID,UserID)
...
if redis:sismember(ALI..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتأكيد كتمه  \n✓️',17,USERCAR) 
end
redis:hset(ALI..'username:'..UserID, 'username', Resolv)
redis:sadd(ALI..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم كتمه \n✓️',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(ALI..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتاكيد الغاء كتمه  \n✓️',17,USERCAR) 
end
redis:srem(ALI..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء كتمه  \n✓️',17,USERCAR) 
end
...
redis:hset(ALI..'username:'..UserID, 'username',Resolv)
redis:sadd(ALI..'gban_users',UserID)
...
redis:srem(ALI..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء حظره العام \n✓️',17,USERCAR) 
end
...
if redis:sismember(ALI..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد مطور \n✓️',17,USERCAR) 
end
redis:hset(ALI..'username:'..UserID, 'username', Resolv)
redis:sadd(ALI..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم ترقيته ليصبح مطور \n✓️',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(ALI..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس مطور \n✓️',17,USERCAR) 
end
redis:srem(ALI..':SUDO_BOT:',UserID)
...
redis:hset(ALI..'username:'..UserID, 'username', UserName)
redis:sadd(ALI..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » ❪ '..UserName..' ❫\n🎟*┇*الايدي » ❪ `'..UserID..'` ❫\n💯*┇*تمت ترقيته ليصبح منشىء في البوت \n✓️')
end
...
if redis:sismember(ALI..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » ❪ '..UserName..' ❫\n🎫*┇*الايدي » ❪ `'..UserID..'` ❫\n💯*┇*تم بالتأكيد حظره \n✓️') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(ALI..'username:'..UserID, 'username', Resolv)
redis:sadd(ALI..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(ALI..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم فگ تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(ALI..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(ALI..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » '..USERNAME..' \n🎫*┇* الايدي » (`'..UserID..'`)\n💯*┇*انه بالتأكيد ليس مطور \n✓') end
redis:srem(ALI..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
...
if redis:get(ALI..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(ALI..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(ALI..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(ALI..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*👮🏾¦*` اعدادات المجموعه :` \n"
.."\n📝┇التعديل ⇜ "..(redis:get(ALI..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗┇الروابط ⇜ "..(redis:get(ALI..'lock_link'..msg.chat_id_) or 'false')
.."\n⃣┇التاك ⇜ "..(redis:get(ALI..'lock_tag'..msg.chat_id_) or 'false')
.."\n©┇المعرفات ⇜ "..(redis:get(ALI..'lock_username'..msg.chat_id_) or 'false')
.."\n💱┇التكرار ⇜ "..(redis:get(ALI..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑┇الكلايش ⇜ "..(redis:get(ALI..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐┇الويب ⇜ "..(redis:get(ALI..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️┇الماركدوان ⇜ "..(redis:get(ALI..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻┇البوتات بالطرد ⇜ "..(redis:get(ALI..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖┇البوتات ⇜ "..(redis:get(ALI..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕┇عدد التكرار ⇜ "..(redis:get(ALI..'num_msg_SUD'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🎬┇`اعدادات الوسائط :`\n"
.."\n*🎑┇*المتحركه ⇜ "..(redis:get(ALI..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭┇الدردشه ⇜ "..(redis:get(ALI..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️┇الانلاين ⇜ "..(redis:get(ALI..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮┇الالعاب ⇜ "..(redis:get(ALI..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞┇الصور ⇜ "..(redis:get(ALI..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥┇الفيديو ⇜ "..(redis:get(ALI..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙┇البصمات ⇜ "..(redis:get(ALI..'mute_audio'..msg.chat_id_) or 'false')
.."\n🔉┇الصوت ⇜ "..(redis:get(ALI..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎┇الملصقات ⇜ "..(redis:get(ALI..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞┇الجهات ⇜ "..(redis:get(ALI..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱┇التوجيه ⇜ "..(redis:get(ALI..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐┇الموقع ⇜ "..(redis:get(ALI..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂┇الملفات ⇜ "..(redis:get(ALI..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅┇الاشعارات ⇜ "..(redis:get(ALI..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒┇الكيبورد ⇜ "..(redis:get(ALI..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚒┇*`اعدادات اخرى : `"
.."\n\n*🙋🏼‍♂️┇*الترحيب ⇜ "..welcomex
.."\n*💬┇*الردود ⇜ "..replayx
...
.."\n*➕┇*عدد التكرار ⇜ "..(redis:get(ALI..'num_msg_SUD'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*💱┇*`اعدادات التقـييد :`\n"
.."\n*💢┇*التقييد بالتوجيه ⇜ "..(redis:get(ALI..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸┇*التقييد بالصور ⇜ "..(redis:get(ALI..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗┇*التقييد بالروابط ⇜ "..(redis:get(ALI..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉┇*التقييد بالمتحركه ⇜ "..(redis:get(ALI..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥┇*التقييد الفيديو ⇜ "..(redis:get(ALI..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❪ مقفول ❫')
list_settings = list_settings:gsub('false', '❪ مفتوح ❫')
